...
def main():
    ...
    # Compare Full and QUBO simulations.
    ...
    results_df.to_excel("annual_cost_deviation_summary_set_3.xlsx", index=False)
    print("\nResults saved to 'annual_cost_deviation_summary_set_3.xlsx'")
